...
\lstinputlisting[%
  ...
  frame=shadowbox,
  numbers=left,
  label=list:AxisPatterns,
  caption={[Implementation of Axis-Related Responsive Patterns]%
    WIP
  },
...
\lstinputlisting[%
  ...
  frame=shadowbox,
  numbers=left,
  label=list:LegendPatterns,
  caption={[Implementation of Legend-Related Responsive Patterns]%
    WIP
  },
...
\lstinputlisting[%
  ...
  caption={[Implementation of Responsive Patterns Targeting Bar Charts]%
    WIP
  },
...
The best way of removing markers is to hide some or all of them by making them transparent via the CSS \code{opacity} property.
...
The recommended way to remove marker labels is to hide them by making them transparent via the CSS \code{opacity} property.
...
\lstinputlisting[%
  ...
  caption={[Implementation of Responsive Patterns Targeting Line Charts]%
    WIP
  },
...
In such situations, rendering labels for all points would only clutter the visualization, and it might be better to hide them by making them transparent via the CSS \code{opacity} property. 
...
\lstinputlisting[%
  ...
  caption={[Implementation of Responsive Patterns Targeting Point Charts]%
    WIP
  },
