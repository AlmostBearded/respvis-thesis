...
A good example of a responsive bar chart created by \textcite{RespVis}
...
{
An example of a responsive bar chart at different display widths. At
70rem, axis tick labels are aligned horizontally. At 50rem, axis tick
labels are aligned vertically. At 30rem, the chart is transposed.
