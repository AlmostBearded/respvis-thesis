...
\item Replication: The structure of the SVG document that shall be
  laid out is replicated with HTML \code{<div>} elements, because
...
\code{<div>} elements. Afterwards, these HTML elements are laid out by
...
their SVG elements when required. \code{<text>} elements are a good
...
are merely \code{<div>} elements which have been styled via CSS rules,
...
as \code{<svg>} and \code{<rect>} elements, the \code{x}, \code{y},
...
container \code{<svg>} and \code{<g>} elements containing
