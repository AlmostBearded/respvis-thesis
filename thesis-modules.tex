...
\code{<svg>} element of an SVG document that has at least the
...
\code{<svg>} element without actual content is not able to receive
...
transparent \code{<rect>} background element filling the whole draw
