...
In RespVis, the Bar Series module renders collections of \code{<rect>}
...
objects have been created and bound to \code{<svg>} or \code{<g>}
...
experience for users. As with all other Series, the \code{enter},
...
collection of \code{<rect>} elements meant for display in the draw
