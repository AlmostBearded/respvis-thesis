...
die \code{uuid} funktion ist ein alias fuer die \code{v4} funktion aus dem \code{uuid} npm package \code{UUIDPackage}.
...
% UUIDPackage https://www.npmjs.com/package/uuid
% UUIDRFC https://www.ietf.org/rfc/rfc4122.txt
...
das \code{Blob} objekt wird dann ueber die \code{URL.createObjectURL} methode in eine object URL konvertiert und im \code{href} attribut eines neu erzeugten \code{<a>} elementes gesetzt.
...
\TODO{Ask keith why i shouldn't explain the svg download functionality here and skip the selected details chapter}
