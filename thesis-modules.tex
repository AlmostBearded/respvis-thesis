...
mainly laid-out container \elname{<svg>} and \elname{<g>} elements
containing exactly-positioned child elements. Dynamically-sized
elements such as \elname{<text>} elements and axes also need to be
...
with \elname{<div>} elements, the layout phase in which these
\elname{<div>} elements are automatically being laid out by the
browser, and the synchronization phase in which the bounding boxes of
the laid out \elname{<div>} elements are being set as
\attrname{bounds} attributes on the original SVG elements. In the
...
final dimensions. \imgcredit{Image created by the author of this
