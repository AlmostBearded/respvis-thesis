...
Bar Series render collections of \code{<rect>} elements representing
...
Bar Charts as \code{<svg>} or \code{<g>} elements to which
...
components of these and render a collection of \code{<rect>} elements
...
categories and subcategories, the \code{categoryfilter} and
\code{subcategoryfilter} events are dispatched, containing the newly
...
default behavior via the \code{chartWindowBarGroupedAutoResize},
