...
% KA list some examples: Illustrator, Inkscape, a charting tool
...
presentation attributes like \cssname{fill} and \cssname{stroke-width}
...
% KA what does SVG2 say about presentation attributes
...
% KA TODO
% make this example 100x100 and 250x250 pixel canvases.
...
The \lstinline{webgl} rendering context enables 3d drawing through the
...
% KA  this is not true: the features are there, just not always
%     accelerated by hardware.
%
% The availability of individual features depends on the client's
% hardware. It is therefore recommendable to only use three-dimensional
% rendering when the requirements do not allow for any of the
% alternatives.

% No: in terms of performance, prefer WebGL if it is available.
