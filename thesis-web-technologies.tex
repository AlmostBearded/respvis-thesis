...
CSS was initially proposed by \textcite{CSSProposal} and standardized into
...
Additionally, studies like \textcite{ToTypeOrNotToType} have evaluated software bugs in publicly available codebases and found that 15\% of them could have been prevented with static type checking.
...
The Scalable Vector Graphics (SVG) format is an XML-based format for vector graphics which describe images as sets of shapes that can be scaled without loss of quality. 
