...
The names of functions that create component data objects are always in the form of \code{componentNameData}, such as \code{chartBarData} or \code{chartBarGroupedData}.
