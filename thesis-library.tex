...
it must not contain any \code{<foreignObject>} elements, which embed
...
\subsection{Extension of D3 rather than Wrapper around D3}
...
basic SVG elements like \code{<rect>}, \code{<circle>}, and
\code{<text>}. These Primitives do not require any data to be bound to
...
and Series. These are usually rendered as \code{<svg>} or \code{<g>}
...
HTML \code{<div>} elements. Their purpose is to nest Charts into a
