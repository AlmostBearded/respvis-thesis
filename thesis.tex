...
\newcommand{\thisdate}{08 May 2022}  % date of this version
...
\ifpdf
  ...
  \usepackage[            % hyperref should be last package loaded
    ...
    pdftex,
    pdfversion=1.7,
    pdftitle={RespVis: A Browser-Based, D3 Extension Library
for Creating Responsive SVG Charts},
%    pdfsubject={Master's Thesis Template},
    pdfauthor={Peter Oberrauner},
    pdfkeywords={master's thesis, responsive, visualization, SVG, information visualization, chart, charting, library, CSS, line chart, bar chart, point chart, scatterplot},
    bookmarks,
    bookmarksnumbered,
    linktocpage,
    colorlinks,
...
\cleardoublepage
\input{thesis-respvis}

\cleardoublepage
\input{thesis-library}

\cleardoublepage
\input{thesis-modules}

\cleardoublepage
\input{thesis-usage} 

\cleardoublepage
\input{thesis-outlook}        
